...
def plot_histogram(authentic_file1, impostor_file1, l1,
    ...
    plt.hist(authentic_score1, bins='auto', histtype='step', density=True,
             label=l1 + ' Authentic', color='b', linewidth=1)
    ...
    if l2 is not None:
        plt.hist(authentic_score2, bins='auto', histtype='step', density=True,
                 label=l2 + ' Authentic', color='r', linewidth=1)
    ...
    if l3 is not None:
        plt.hist(authentic_score3, bins='auto', histtype='step', density=True,
                 label=l3 + ' Authentic', color='g', linewidth=1)
    ...
    if l4 is not None:
        plt.hist(authentic_score4, bins='auto', histtype='step', density=True,
                 label=l4 + ' Authentic', color='k', linewidth=1)
    ...
    if l5 is not None:
        plt.hist(authentic_score5, bins='auto', histtype='step', density=True,
                 label=l5 + ' Authentic', color='c', linewidth=1)
    ...
    if l6 is not None:
        plt.hist(authentic_score6, bins='auto', histtype='step', density=True,
                 label=l6 + ' Authentic', color='m', linewidth=1)
    ...
    if l5 is not None:
        d_prime5 = (abs(np.mean(authentic_score5) - np.mean(impostor_score5)) /
                    np.sqrt(0.5 * (np.var(authentic_score5) + np.var(impostor_score5))))
        colors.append('c')
        labels.append("d-prime: {}".format(np.round(d_prime5, 3)))

        print('d-prime for {} is: {} '.format(l4, d_prime5))
    
    if l6 is not None:
        d_prime6 = (abs(np.mean(authentic_score6) - np.mean(impostor_score6)) /
                    np.sqrt(0.5 * (np.var(authentic_score6) + np.var(impostor_score6))))
        colors.append('m')
        labels.append("d-prime: {}".format(np.round(d_prime6, 3)))

        print('d-prime for {} is: {} '.format(l4, d_prime6))
