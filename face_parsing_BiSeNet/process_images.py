...
# This python file is based on the original repository which has been modified to process whole image directory at once
...
def vis_parsing_maps(im, parsing_anno, stride, save_im=False, save_path='vis_results/parsing_map_on_im.jpg'):
    ...
    vis_parsing_anno_color[index[0], index[1], :] = part_colors[0]
    ...
    if save_im:
        ...
        cv2.imwrite(save_path[:-4] + 'annotation.png', mask)
